  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{\`npm install @gpters-internal/ui\`}</code></pre>
      </section>

      <section className="space-y-6">
        <h2 className="text-2xl font-semibold">Usage</h2>
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{\`import { ${pascalName} } from '@gpters-internal/ui';\`}</code></pre>
