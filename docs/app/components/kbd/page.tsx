export default function KbdPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold tracking-tight mb-2">Kbd</h1>
        <p className="text-lg text-muted-foreground">
          Kbd component from the design system.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{`import { Kbd } from '@design-geniefy/ui';`}</code></pre>
