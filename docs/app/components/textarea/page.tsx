export default function TextareaPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold tracking-tight mb-2">Textarea</h1>
        <p className="text-lg text-muted-foreground">
          Textarea component from the design system.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{`import { Textarea } from '@design-geniefy/ui';`}</code></pre>
