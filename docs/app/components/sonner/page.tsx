export default function SonnerPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold tracking-tight mb-2">Sonner</h1>
        <p className="text-lg text-muted-foreground">
          Sonner component from the design system.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{`import { Sonner } from '@design-geniefy/ui';`}</code></pre>
