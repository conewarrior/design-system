export default function TooltipPage() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-4xl font-bold tracking-tight mb-2">Tooltip</h1>
      ...
      <section className="space-y-6">
        ...
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{`import { Tooltip } from '@design-geniefy/ui';`}</code></pre>
