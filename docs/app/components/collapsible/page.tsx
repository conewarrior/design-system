    ...
    <div className="space-y-12">
      <div>
        ...
        <p className="text-lg text-muted-foreground">
          Collapsible component from the design system.
        </p>
      </div>
      ...
      <section className="space-y-6">
        ...
        <pre className="bg-muted rounded-md p-4 overflow-x-auto"><code>{`import { Collapsible } from '@design-geniefy/ui';`}</code></pre>
